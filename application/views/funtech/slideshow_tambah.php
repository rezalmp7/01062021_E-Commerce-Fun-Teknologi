                ...
                <div class="uk-width-1-1 uk-padding-remove uk-margin-remove" id="isi_content">
                    <form class="uk-form-stacked uk-margin-medium-top" method="post" enctype='multipart/form-data' action="<?php echo base_url(); ?>funtech/slideshow/tambah_aksi">
                        <div class="uk-padding-remove uk-margin-remove uk-width-1-1">
                            <div class="uk-width-3-5 uk-padding-small">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input" id="form-stacked-text" type="text" name="judul" placeholder="Judul..." required>
                                    </div>
                                </div>
                                <div class="uk-margin">
                                    <label class="uk-form-label" for="form-stacked-text">Deskripsi</label>
                                    <div class="uk-form-controls">
                                        <textarea class="uk-textarea" id="form-stacked-text" name="deskripsi" placeholder="Judul..." required></textarea>
                                    </div>
                                </div>
                                <div class="uk-margin">
